...
export class MetricsService implements OnModuleInit, OnModuleDestroy {
    ...
    private initHttpMetrics() {
        ...
        this.httpActiveRequests = this.meter.createGauge(
    ...
    private initSystemMetrics() {
        this.memoryUsageRss = this.meter.createGauge(
        ...
        this.memoryUsageHeapTotal = this.meter.createGauge(
        ...
        this.memoryUsageHeapUsed = this.meter.createGauge(
        ...
        this.memoryUsageExternal = this.meter.createGauge(
        ...
        this.cpuUsageUser = this.meter.createGauge(
        ...
        this.cpuUsageSystem = this.meter.createGauge(
        ...
        this.eventLoopLag = this.meter.createGauge(
    ...
    private initApplicationMetrics() {
        this.activeUsers = this.meter.createGauge(
            "app_active_users",
            {
        ...
        this.dbQueryTotal = this.meter.createCounter(
            "db_queries_total",
            {
        ...
        this.queueJobTotal = this.meter.createCounter(
            "queue_jobs_total",
            {
        ...
        this.queueJobFailures = this.meter.createCounter(
        ...
        this.authLoginTotal = this.meter.createCounter(
            "auth_login_total",
            {
        ...
        this.authLoginFailures = this.meter.createCounter(
